...
# 拉取远程仓库到本地
git clone https://github.com/0x0CFF/NixOS.git

# 复制配置文件
cp -f ./NixOS/NixOS-Configuration/configuration.nix /mnt/etc/nixos/
...
```shell
# 拉取远程配置文件
# git clone https://github.com/0x0CFF/NixOS.git /home/0x0CFF/Solution/Blueprints/NixOS
GIT

# NAVI [studio]: 替换硬件信息到 NixOS-Flake 相应文件夹下

# 将系统 FLAKE 化（执行后，NixOS 切换到 Flake 模式，可执行 Flake 对应操作）
# sudo sh /home/0x0CFF/Solution/Blueprints/NixOS/Script/Studio/nixos-install.sh
FLAKE-STUDIO
