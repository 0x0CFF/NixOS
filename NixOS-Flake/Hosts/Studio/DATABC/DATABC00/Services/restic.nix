  ...
  services = {
    restic.backups = {
      DATABC00 = {
        ...
        initialize = true
        # 仓库密码文件
        passwordFile = "/home/0x0CFF/Solution/Blueprints/NixOS/NixOS-Flake/Modules/Common/Services/Automation/Restic/Dotfiles/restic-password";
        # 备份定时器
        timerConfig = {
        ...
        # rclone 配置文件
        rcloneConfigFile = "/home/0x0CFF/Solution/Blueprints/NixOS/NixOS-Flake/Hosts/Studio/DATABC/DATABC00/Services/Dotfiles/rclone.conf";
