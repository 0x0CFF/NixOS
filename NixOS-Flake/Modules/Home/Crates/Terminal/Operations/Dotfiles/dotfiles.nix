{ config, pkgs, inputs, ... }:let
  ...
  dtopConfigPath = "${config.home.homeDirectory}/Solution/Blueprints/NixOS/NixOS-Flake/Modules/Home/Crates/Terminal/Operations/Dotfiles/Dtop";
in
{
  ...
  xdg.configFile."dtop".source = config.lib.file.mkOutOfStoreSymlink dtopConfigPath;
}
