{ config, pkgs, inputs, ... }:let
  ...
  helixConfigPath = "${config.home.homeDirectory}/Solution/Blueprints/NixOS/NixOS-Flake/Modules/Common/Crates/Terminal/Explorer/Dotfiles/Helix";
  yaziConfigPath = "${config.home.homeDirectory}/Solution/Blueprints/NixOS/NixOS-Flake/Modules/Common/Crates/Terminal/Explorer/Dotfiles/Yazi";
in
{
  ...
  xdg.configFile."yazi".source = config.lib.file.mkOutOfStoreSymlink yaziConfigPath;
}
