{ config, pkgs, inputs, ... }:let
  ...
  helixPath = "${config.home.homeDirectory}/Solution/Blueprints/NixOS/NixOS-Flake/Modules/Common/Crates/Terminal/Explorer/Dotfiles/Helix";
  yaziPath = "${config.home.homeDirectory}/Solution/Blueprints/NixOS/NixOS-Flake/Modules/Common/Crates/Terminal/Explorer/Dotfiles/Yazi";
in
{
