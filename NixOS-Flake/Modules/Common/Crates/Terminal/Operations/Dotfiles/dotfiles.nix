{ config, pkgs, inputs, ... }:let
  ...
  bottomPath = "${config.home.homeDirectory}/Solution/Blueprints/NixOS/NixOS-Flake/Modules/Common/Crates/Terminal/Operations/Dotfiles/Bottom";
  naviPath = "${config.home.homeDirectory}/Solution/Blueprints/NixOS/NixOS-Flake/Modules/Common/Crates/Terminal/Operations/Dotfiles/Navi";
  zellijPath = "${config.home.homeDirectory}/Solution/Blueprints/NixOS/NixOS-Flake/Modules/Common/Crates/Terminal/Operations/Dotfiles/Zellij";
in
{
