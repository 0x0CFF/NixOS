{
  ...
  nixConfig = {
    ...
    #   "httpors.nju.edu.cn/nix-channels/store"                                                         # 南京大学
  ...
  outputs = inputs@{ self, nixpkgs, unstable, agenix, home-manager, ... }:{
    ...
    nixosConfigurations."DATAGC00" = nixpkgs.lib.nixosSystem {
      ...
      modules = [
        ...
        ./Modules/Common/Crates/Terminal/IT/default.nix                                                 # 终端 IT 工具集合
        ./Modules/Common/Crates/Terminal/Life/default.nix                                               # 终端日用工具集合
        ...
        ./Modules/Common/Crates/Terminal/Security/default.nix                                           # 终端安全程序集合
    ...
    nixosConfigurations."DATABC00-BACKUP" = nixpkgs.lib.nixosSystem {
      ...
      modules = [
        ...
        ./Hosts/Studio/DATABC/DATABC00-BACKUP/Timers/gc-samba.nix                                       # Samba 垃圾回收
    ...
    nixosConfigurations."DATASC00" = nixpkgs.lib.nixosSystem {
      ...
      modules = [
        ...
        ./Hosts/Studio/DATASC/DATASC00/Timers/gc-mount-point.nix                                        # 挂载点垃圾回收
        # ./Hosts/Studio/DATASC/DATASC00/Timers/health-disk.nix                                           # 硬盘定时检查
    ...
    nixosConfigurations."DATASC00-BACKUP" = nixpkgs.lib.nixosSystem {
      ...
      modules = [
        ...
        # ./Hosts/Studio/DATASC/DATASC00-BACKUP/Timers/health-disk.nix                                    # 硬盘定时检查
    ...
    nixosConfigurations."DATASC01" = nixpkgs.lib.nixosSystem {
      ...
      modules = [
        ...
        ./Hosts/Studio/DATASC/DATASC01/Timers/gc-mount-point.nix                                        # 挂载点垃圾回收
        ./Hosts/Studio/DATASC/DATASC01/Timers/gc-samba.nix                                              # Samba 垃圾回收
        # ./Hosts/Studio/DATASC/DATASC01/Timers/health-disk.nix                                           # 硬盘定时检查
    ...
    nixosConfigurations."DATASC01-BACKUP" = nixpkgs.lib.nixosSystem {
      ...
      modules = [
        ...
        ./Hosts/Studio/DATASC/DATASC01-BACKUP/Timers/gc-samba.nix                                       # Samba 垃圾回收
        # ./Hosts/Studio/DATASC/DATASC01-BACKUP/Timers/health-disk.nix                                    # 硬盘定时检查
